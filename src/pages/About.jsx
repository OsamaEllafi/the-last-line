        ...
        <div className="max-w-4xl mx-auto px-6 w-full">
           <div className="bg-[#0F0E17] border border-white/20 font-mono shadow-[0_0_30px_rgba(0,255,231,0.1)] relative overflow-hidden">
              ...
              <div className="p-8 text-sm md:text-base text-[#00FFE7] leading-relaxed">
                 ...
                 <a href="/book-appointment" className="inline-block mt-4 px-6 py-2 bg-[#00FFE7]/10 border border-[#00FFE7] text-[#00FFE7] hover:bg-[#00FFE7] hover:text-[#0F0E17] transition-colors uppercase tracking-widest font-bold font-sans">
                    Open Channel
                 </a>
              </div>
           </div>
